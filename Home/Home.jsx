...
import "./home.css";
import vg from "../../assets/images/Learning-cuate.png";
import {} from "react-icons";
import {SiCoursera, SiUdemy, SiGoogle, SiYoutube} from "react-icons/si";
        ...
        <Box padding={"8"} bg="blackAlpha.800">
            <Heading
             ...
             color={'yellow.400'}
               children="OUR BRANDS"
               />
               <HStack className='brandsNanner' justifyContent={'space-evenly'} marginTop="4">
                <SiGoogle />
                <SiYoutube />
                <SiCoursera />
                <SiUdemy />
